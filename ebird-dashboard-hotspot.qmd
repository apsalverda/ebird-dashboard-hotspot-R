...
output$species_count_plot = renderGirafe({
  ...
  girafe(
    ggobj = plot, 
    pointsize = 40,
    width_svg = (0.70 * input$pltChange$width / input$pltChange$dpi),
    height_svg = (0.42 * input$pltChange$height / input$pltChange$dpi)
  ) %>% 
    girafe_options(
...
## Species plot {height=60%}

```{r}
#| title: Species reported by checklist
