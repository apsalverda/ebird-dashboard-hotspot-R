  ...
  selected_dat() %>%
    ...
    as.datatable(
      ...
      options = list(
        dom = "ft",
        #        scrollY = "45vh",
        scrollY = paste0((0.65 * (input$pltChange$height - 200)), "px"),
        #        scrollY = "500px",
        pageLength = 1000
      )
    )
...
tags$div(
  style = "margin-bottom: -20px; /* Adjust this value as needed */",
  fileInput(
    "upload",
...
p(
  "Created by ",
  a("Anne Pier Salverda ", href = "mailto:salverda@yahoo.com?subject='Your eBird dashboard'"),
  bs_icon("feather")
)
```
...
## Tabs {height=89%, .tabset expandable=false overflow=hidden}
