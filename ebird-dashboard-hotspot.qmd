...
div(
  style = "display: inline-block; padding-top: 0px; margin-top: 0px; margin-left: 16px; margin-right: 16px; font-size: 15px; margin-bottom: 100px;",
  sliderInput(
    "year_list_slider",
    "",
    min = 2020,
  ...
  p("Total species reported") 
)
# div(
#   style = "margin-bottom: 75px; margin-top: 0px",
#   numericInput(
#     "year1",
#     "",
#     value = 1,
...
# )
div(
  style = "margin-top: 10px; font-size: .75em;",
...
# div(
#   style = "margin-top: 0px;",
#   plotOutput("year_plot2")
# )

div(
  style = "margin-top: 10px; font-size: .75em;",
  DT::DTOutput("year2_table", height = "50%")
)
# selectInput(
#   "year1",
#   "",
