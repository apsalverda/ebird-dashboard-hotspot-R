...
output$data_observations = DT::renderDT({
  ...
  observations_table =
    selected_dat() %>%
    arrange(date, time) %>%
    select(date, count, common_name, location, submission_id) |>
    #     mutate(
...
div(a("eBird Best Practices", href = "https://support.ebird.org/en/support/solutions/articles/48000795623-ebird-rules-and-best-practices", target = "_blank"),
